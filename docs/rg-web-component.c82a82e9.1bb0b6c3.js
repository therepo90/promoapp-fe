...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"hgTY":[function(require,module,exports) {
var define;
    ...
    const e = (e, t) => {
      customElements.define(t, class extends HTMLElement {
        ...
        setupWebGL() {
          ...
          if (!t) return void console.error("Unable to initialize WebGL. Your browser may not support it.");
          let r = require("./fragment-main.glsl");
          const o = this.fragmentCode;
          r = r.replace('#include "fragment.glsl"', o);
          const n = require("./vertex.glsl"),
            i = r,
            a = this.compileShader(t, t.VERTEX_SHADER, n),
            s = this.compileShader(t, t.FRAGMENT_SHADER, i);
          if (!a || !s) return void console.error("Shader compilation failed.");
          const l = this.createProgram(t, a, s);
          if (!l) return void console.error("Shader program linking failed.");
          ...
          if (-1 === g) return void console.error("Unable to get attribute location for a_position");
          ...
          if (null === h || null === m) return void console.error("Unable to get uniform location(s)");
        ...
        compileShader(e, t, r) {
          ...
          return e.shaderSource(o, r), e.compileShader(o), e.getShaderParameter(o, e.COMPILE_STATUS) ? o : (console.error(`Error compiling shader: ${e.getShaderInfoLog(o)}`), e.deleteShader(o), null);
        }
        createProgram(e, t, r) {
          const o = e.createProgram();
          return e.attachShader(o, t), e.attachShader(o, r), e.linkProgram(o), e.getProgramParameter(o, e.LINK_STATUS) ? o : (console.error(`Unable to initialize the shader program: ${e.getProgramInfoLog(o)}`), null);
        }
        setupMouseListeners() {
          const e = this.shadowRoot.getElementById("rg-wgl-loader-canvas");
